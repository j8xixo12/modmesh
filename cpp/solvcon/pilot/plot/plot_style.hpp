 ...
 *
 * Nothing here may mention Qt. The vocabulary compiles into the no-GUI test
 * target, so a Qt include breaks the build on every runner. Converting a
 * PlotColor to a QColor belongs in the Qt front end, at that boundary and
 * nowhere else.
 *
