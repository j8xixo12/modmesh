...
// The matplotlib "tab10" categorical cycle, i.e. the C0-C9 shorthand every
// matplotlib user already reads. Reusing it verbatim is the whole point: a
// pilot plot of the same data looks like the plot the user would have made
// with matplotlib, so the color carries the same meaning in both.
