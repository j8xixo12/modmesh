...
// The matplotlib "tab10" cycle, i.e. the C0-C9 shorthand every matplotlib user
// already reads (https://matplotlib.org/stable/users/explain/colors/colors.html).
// Reusing it verbatim is the point: a pilot plot of the same data looks like
// the plot the user would have made with matplotlib, so the color carries the
