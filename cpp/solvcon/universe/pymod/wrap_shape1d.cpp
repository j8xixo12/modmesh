...
template <typename T>
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapSegmentPad
...
template <typename T>
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapBezier3d
...
template <typename T>
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapCurvePad
